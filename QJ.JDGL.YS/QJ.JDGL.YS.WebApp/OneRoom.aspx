<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OneRoom.aspx.cs" Inherits="QJ.JDGL.YS.WebApp.stay1" %>
        ...
        <div>
            ...
            <div id="sidebar">
                ...
                <ul>
                    <li class="submenu"><a href="index.aspx"><i class="icon icon-signal"></i><span>房间信息</span></a>
                        <ul>
                            <li class="active"><a href="OneRoom.aspx">标准间</a></li>
            ...
            <div id="content">
                <div id="content-header">
                    ...
                    <div class="all">
                        <br />
                        <p style="text-align: center; font-size: 40px; margin-top: 30px; margin-bottom: 50px;">标准间</p>
                        <div class="top">
                        ...
                        <div class="right">
                            <h3 style="margin-bottom: 10px">七瑾大床房</h3>
