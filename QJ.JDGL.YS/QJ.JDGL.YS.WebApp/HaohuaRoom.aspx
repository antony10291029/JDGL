<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HaohuaRoom.aspx.cs" Inherits="QJ.JDGL.YS.WebApp.HaohuaRoom" %>
                ...
                <ul>
                    <li class="submenu"><a href="index.aspx"><i class="icon icon-signal"></i><span>房间信息</span></a>
                        <ul>
                            ...
                            <li class="active"><a href="HaohuaRoom.aspx">豪华套房</a></li>
                        </ul>
                    </li>
            ...
            <div id="content">
                <div id="content-header">
                    <div id="breadcrumb">
                        ...
                        <a href="#" class="current">豪华套房</a>
                    </div>
                    <div class="all">
                        <br />
                        <p style="text-align:center;font-size:40px;margin-top: 30px;margin-bottom: 50px;">豪华套房</p>
                        <div class="top">
                            ...
                            <div class="box">
                                <div class="box-1">
                                    <ul style="list-style: none;">
                                        <li>
                                            <img src="img/jpg/豪华套房1.jpg" />
                                        </li>
                                        <li>
                                            <img src="img/jpg/豪华套房2.jpg" />
                                        </li>
                                        <li>
                                            <img src="img/jpg/豪华套房3.jpg" />
                                        </li>
                                        <li>
                                            <img src="img/jpg/豪华套房4.jpg" />
                                        </li>
                                        <li>
                                            <img src="img/jpg/豪华套房5.jpg" />
                                        </li>
                                        <li>
                                            <img src="img/jpg/豪华套房6.jpg" />
                                        </li>
                                    </ul>
                                </div>
                                <div class="box-2">
                        ...
                        <div class="right">
                            <h3 style="margin-bottom: 10px">七瑾豪华套房</h3>
                            ...
                            <div class="right_info">
                                <dl style="display: inline-block;">
                                    <dt>床型</dt>
                                    <dd style="margin-left: 25px;">2张 大床1.8米</dd>
                                </dl>
                            </div>
                            <div class="right_info">
                                <dl style="display: inline-block;">
                        ...
                        <table class="bottom_info" border="0">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="col">
                                        <asp:LinkButton ID="LinkButton3" CssClass="col6" runat="server" Style="text-decoration: none"  data-toggle="modal" data-target="#myModal">
                                <div class="btn_yudin">预定</div>
                                <div class="btn_danbao">
                                    <span class="btn_dbspan">担保</span>
                                </div>
                        ...
                        <table class="bottom_info" border="0">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="col5 col">
                                        <p style="color: #f60;">￥430</p>
                                    </td>
                                    <td class="col">
                                        <asp:LinkButton ID="LinkButton4" CssClass="col6" runat="server" Style="text-decoration: none"  data-toggle="modal" data-target="#myModal">
                                <div class="btn_yudin">预定</div>
                                <div class="btn_danbao">
                                    <span class="btn_dbspan">担保</span>
                                </div>
