<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="baoxiu.aspx.cs" Inherits="QJ.JDGL.YS.WebApp.baoxiu" %>
            ...
            <div id="sidebar">
             ...
             <div id="content">
                <div id="content-header">
                     <div id="breadcrumb">
                         <a href="index.aspx" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>房间信息</a> <a href="#" class="current">报修中心</a>
                     </div>
                     <div class="yemian">
                                 ...
                                 <ItemTemplate>
                                     <tbody>
                                        <tr>
                                            ...
                                            <td><%#Eval("wupin") %></td>
                                            <td><%#Eval("shijian") %></td>
                                            <td><%#Eval("ischulistring") %></td>
                                            <td><%#Eval("chushijian") %></td>
                                            <td>
                                                <asp:LinkButton ID="LinkButton1" runat="server" CommandName="update" CommandArgument='<%#Eval("baoid") %>'>处理</asp:LinkButton>
